...
"""autogenerated by genpy from image_ros_msgs/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','image_ros_msgs/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = image_ros_msgs.msg.BoundingBox()
        _x = val1
        start = end
        end += 42
